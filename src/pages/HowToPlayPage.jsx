  ...
  return (
    <PageLayout title="How To Play">
      ...
      <Card>
        ...
        <StepRow num={1} text="Play the daily challenge every day to earn caps. Each successful completion adds one." />
        <StepRow num={2} text="Miss just one day and nothing happens — you're safe." />
        <StepRow num={3} text="Miss two or more days in a row and your caps start to decay. Play again to stop it." />
        <StepRow num={4} text="Caps unlock status tiers from Academy Prospect all the way up to Hall of Fame." />
      </Card>
